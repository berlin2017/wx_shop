...
Page({
  ...
  orderSubmit: function(t) {
    ...
    if (1 == o.is_form) {
      var d = o.list;
      for (var n in d)
        if ("date" == d[n].type && (d[n].default = d[n].default ? d[n].default : a.data.time),
          "time" == d[n].type && (d[n].default = d[n].default ? d[n].default : "00:00"), 1 == d[n].required)
          if ("radio" == d[n].type || "checkboxc" == d[n].type) {
            var r = !1;
    ...
    if (i.form = JSON.stringify(o), a.data.cart_id_list && (i.cart_id_list = JSON.stringify(a.data.cart_id_list)),
      ...
      var c = [];
      for (var n in a.data.mch_list)
        if (a.data.mch_list[n].cart_id_list) {
          var _ = {
    ...
    a.data.goods_info && (i.goods_info = JSON.stringify(a.data.goods_info)), a.data.picker_coupon && (i.user_coupon_id = a.data.picker_coupon.user_coupon_id),
      ...
      i.payment = a.data.payment, i.formId = t.detail.formId, i.shop_id= a.data.shop.id,a.order_submit(i, "s");
  },
  onReady: function() {},
  onShow: function() {
    var that = this;
    ...
    wx.getLocation({
      success: function(res) {
        ...
        var a = wx.getStorageSync("picker_address");
        if (a) {
  ...
  getOrderData: function(t) {
    ...
    if (s.data.address && s.data.address.id && (e = s.data.address.id), a.address_id = e,
      a.lng = s.data.location.latitude, a.lat = s.data.location.longitude, wx.showLoading({
        title: "正在加载",
        mask: !0
      }), t.cart_list) {
  ...
  getPrice: function() {
    ...
    if (t.data.goods_list && 0 < t.data.goods_list.length && (i && (a -= i.sub_price),
        ...
        0 == n && (a += e)), t.data.mch_list && t.data.mch_list.length)
